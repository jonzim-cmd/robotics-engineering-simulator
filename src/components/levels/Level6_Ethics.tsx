    ...
    <div className="relative min-h-screen">
      <AnimatePresence mode="wait">
          ...
          >
            <div className="flex min-h-full items-center justify-center p-4 md:p-8 lg:p-12">
              <motion.div
                ...
                className="bg-white text-black max-w-2xl md:max-w-3xl lg:max-w-4xl w-full shadow-2xl p-8 md:p-12 lg:p-16 relative"
              ...
              <div className="mt-16 md:mt-20 pt-4 md:pt-6 border-t border-gray-300 text-xs md:text-sm text-gray-400 text-center">
                ...
                <p className="mt-1">A physical system cannot be conscious. Only a simulation can be conscious.</p>
              </div>
        ...
        {showEmail && (
          ...
          >
            <motion.div
               ...
               className="w-full max-w-3xl md:max-w-4xl lg:max-w-5xl bg-slate-800 rounded-lg shadow-2xl overflow-hidden flex flex-col h-[85vh] border border-slate-700"
            >
              {/* Email Header */}
              <div className="bg-slate-900 p-4 md:p-5 lg:p-6 border-b border-slate-700 flex justify-between items-center shrink-0">
              ...
              {/* Email Fields */}
              <div className="p-4 md:p-6 lg:p-8 space-y-4 md:space-y-5 bg-slate-800 flex-1 flex flex-col overflow-hidden">
                <div className="grid grid-cols-[80px_1fr] md:grid-cols-[100px_1fr] gap-2 items-center shrink-0">
              ...
              <div className="bg-slate-900 p-4 md:p-5 lg:p-6 border-t border-slate-700 flex justify-between items-center shrink-0">
        ...
        {showSuccess && (
           ...
           >
              <div className="flex min-h-full items-center justify-center p-6 md:p-10 lg:p-12">
                 <motion.div
                    initial={{ opacity: 0, scale: 0.8 }}
                    animate={{ opacity: 1, scale: 1 }}
                    transition={{ duration: 1 }}
                    className="w-full max-w-2xl md:max-w-3xl lg:max-w-4xl space-y-8 md:space-y-10 lg:space-y-12 my-8 text-center"
                 >
